  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 w-full h-full flex flex-col items-center justify-center px-16 py-20 lg:px-24 lg:py-28 xl:px-32 xl:py-36">
        ...
        >
          {/* Invitation line (inside box) - Updated */}
          <motion.span
            className="text-white/90 tracking-[0.18em] uppercase text-sm lg:text-base xl:text-lg block font-semibold drop-shadow-2xl"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2, duration: 0.6 }}
          >
            We cordially invite you at the royal wedding of
          </motion.span>

          {/* Names */}
          <div className="space-y-1 lg:space-y-2 mt-3">
            <motion.h1
